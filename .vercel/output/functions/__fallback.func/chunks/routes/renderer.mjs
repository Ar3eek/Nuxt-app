...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/ikona.png"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"pl"},"title":"System Raportów"};
