...
import { p as parseURL, l as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, i as joinURL, w as withQuery, s as sanitizeStatusCode, q as getContext, $ as $fetch, t as defu, c as createError$1, v as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "reports-create",
    path: "/reports/create",
    component: () => import('./create-BtEd7jLD.mjs')
  },
  {
    name: "reports-list",
    path: "/reports/list",
    component: () => import('./list-D2U8h6hD.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-Bkkn1yFQ.mjs')
  },
  {
    name: "kontakt",
    path: "/kontakt",
    component: () => import('./kontakt-DVPagrKz.mjs')
  },
  {
    name: "manager",
    path: "/manager",
    component: () => import('./manager-1-2Z24ik.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./index-B9ULrhVT.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BxLNxDEC.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DU-tkAU4.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C_QbmM8S.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BcuXO8Sx.mjs'));
