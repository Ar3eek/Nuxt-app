...
const styles = {
  "pages/kontakt.vue": () => import('./kontakt-styles.PZddLtuw.mjs').then(interopDefault),
  "pages/kontakt.vue?vue&type=style&index=0&scoped=774510bd&lang.css": () => import('./kontakt-styles.PZddLtuw.mjs').then(interopDefault),
